    ...
    <div id="container">
        ...
        <?php include '../../include/sildeber-left.php';?>
            <div style="height:100vh" class="sidebar-right">
                <h1>Danh Sách Tài Khoản Registered Users Last 30 Days </h1>
            <?php
                $Permission=1;
                $stmt = $conn->prepare("select * from taikhoan where Permission=? and date(DaTe)>=now() - INTERVAL 30 day");
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_acount.php?ID=<?php echo $row["ID"]?>&total_users_in30days=1"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
            }
