    ...
    <div id="container">
        ...
        <?php include '../../include/sildeber-left.php';?>
            ...
            <?php
                $Permission2=2;
                $Permission3=3;
                $stmt = $conn->prepare("SELECT * FROM taikhoan where ID!=? and (Permission=? or Permission=?)  order by DaTe DESC");
                $stmt->bind_param("iii",$_SESSION["ID"],$Permission2,$Permission3);
                $stmt->execute();
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_acount.php?ID=<?php echo $row["ID"]?>&total_admins=1"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
            }
